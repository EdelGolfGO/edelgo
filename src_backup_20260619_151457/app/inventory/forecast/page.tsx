...
export default function ForecastPage() {
  ...
  const selectStyle = { background: "#1A1E22", border: "0.5px solid rgba(255,255,255,0.10)", color: "#fff", padding: "8px 12px", fontSize: "12px", fontFamily: "'Barlow', sans-serif", outline: "none", cursor: "pointer" }
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "10px" }}>
        {[
          { label: "SKUs Need Reorder", value: filteredNeedsReorder.length.toString(), color: filteredNeedsReorder.length > 0 ? "#A91E22" : "#5A9E5A", top: filteredNeedsReorder.length > 0 ? "#A91E22" : "#2A2A2A" },
        ...
        <div style={{ background: "#22262B", border: "0.5px solid rgba(169,30,34,0.2)", borderTop: "2px solid #A91E22" }}>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse" }}>
            ...
            <tbody>
              {filteredNeedsReorder.map(item => {
                ...
                return (
                  ...
                  >
                    ...
                    <td style={{ padding: "10px 14px", borderBottom: "0.5px solid rgba(255,255,255,0.04)" }}>
                      <span style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: "10px", fontWeight: 700, letterSpacing: "0.08em", textTransform: "uppercase", color: "#888", background: "rgba(255,255,255,0.05)", padding: "2px 7px" }}>
              ...
              <tr style={{ background: "#1A1E22" }}>
                <td colSpan={7} style={{ padding: "10px 14px", fontFamily: "'Barlow Condensed', sans-serif", fontSize: "11px", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", color: "#555", textAlign: "right" }}>
                  Total Reorder Cost
                </td>
