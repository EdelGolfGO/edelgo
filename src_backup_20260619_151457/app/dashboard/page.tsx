    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "10px" }}>
        {[
          ...
          <div key={stat.label} onClick={() => router.push(stat.href)}
            style={{ background: "#22262B", border: "0.5px solid rgba(255,255,255,0.10)", borderTop: `2px solid ${stat.top}`, padding: "18px 20px", cursor: "pointer" }}
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "10px" }}>
        {[
          ...
          <div key={stat.label} onClick={() => router.push(stat.href)}
            style={{ background: "#22262B", border: "0.5px solid rgba(255,255,255,0.10)", borderTop: "2px solid #2A2A2A", padding: "16px 20px", cursor: "pointer" }}
            onMouseEnter={e => e.currentTarget.style.background = "#262B30"}
            onMouseLeave={e => e.currentTarget.style.background = "#22262B"}
          >
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "10px" }}>
        {[
          ...
          <div key={link.label} onClick={() => router.push(link.href)}
            style={{ background: "#22262B", border: "0.5px solid rgba(255,255,255,0.08)", borderTop: `2px solid ${link.color}`, padding: "14px 16px", cursor: "pointer" }}
            onMouseEnter={e => e.currentTarget.style.background = "#262B30"}
            onMouseLeave={e => e.currentTarget.style.background = "#22262B"}
          >
