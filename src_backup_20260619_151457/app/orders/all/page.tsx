      ...
      <div style={{ display: "flex", gap: "8px", alignItems: "center" }}>
        ...
        {(["all", "wholesale", "fitter", "retail", "international", "factory", "misc"] as const).map(t => (
          <button key={t} onClick={() => setOrderType(t)}
            style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: "10px", fontWeight: 700, letterSpacing: "0.08em", textTransform: "uppercase", padding: "5px 12px", cursor: "pointer", border: "none", background: orderType === t ? "#A91E22" : "transparent", color: orderType === t ? "#fff" : "#555", outline: orderType === t ? "none" : "1px solid #2A2A2A" }}>
                  ...
                  <div style={{ borderTop: "0.5px solid rgba(255,255,255,0.08)", padding: "16px 20px", background: "#1E2226" }}>
                    ...
                    <div style={{ display: "flex", gap: "10px", flexWrap: "wrap", alignItems: "center" }}>
                      ...
                      <button onClick={e => { e.stopPropagation(); printOrder(order) }}
                        style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: "11px", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", color: "#888", background: "transparent", border: "1px solid #333", padding: "7px 14px", cursor: "pointer", display: "flex", alignItems: "center", gap: "5px" }}>
            ...
            <div style={{ padding: "20px 24px", display: "flex", flexDirection: "column", gap: "16px" }}>
              <div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
                  ...
                  {editItems.length === 0 && (
                    <p style={{ fontSize: "12px", color: "#444", fontFamily: "'Barlow', sans-serif", padding: "16px 0" }}>No line items.</p>
                  )}
                </div>
              ...
              <div style={{ background: "#22262B", border: "0.5px solid rgba(255,255,255,0.08)", padding: "14px 16px" }}>
                ...
                {notifyDealer && (
                  <div>
                    <p style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: "9px", fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "#444", marginBottom: "5px" }}>Reason for change (optional)</p>
