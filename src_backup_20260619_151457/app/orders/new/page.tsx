  ...
  if (submitted) {
    return (
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "60vh", gap: "16px", textAlign: "center" }}>
        ...
        <p style={{ fontSize: "14px", color: "#888", fontFamily: "'Barlow', sans-serif", margin: 0 }}>Order submitted for review. Approve it from All Orders.</p>
          ...
          {orderItems.length === 0 ? (
            ...
            <>
              ...
              <div style={{ padding: "14px 16px", borderTop: "0.5px solid rgba(255,255,255,0.08)" }}>
                ...
                <p style={{ fontSize: "10px", color: "#444", textAlign: "center", marginTop: "8px", fontFamily: "'Barlow', sans-serif" }}>Order will go to Pending Review for approval</p>
              </div>
            </>
          )}
        </div>
