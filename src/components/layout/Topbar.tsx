    ...
    <>
      <header style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "20px" }}>
          <span style={{ fontSize: "10px", fontWeight: 500, letterSpacing: "0.14em", textTransform: "uppercase", color: "#787E87", fontFamily: "'Barlow Condensed', sans-serif" }}>Spring 2026</span>
          ...
          <div
            ...
            title="View Alerts"
          >
            <Bell size={18} color={unreadCount > 0 ? "#C4A93A" : "#787E87"} />
            {unreadCount > 0 && (
              <div style={{
          ...
          <div style={{ position: "relative" }}>
            <div
              ...
              {profile?.full_name && (
                <span style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: "12px", fontWeight: 700, color: "#B5BAC2", letterSpacing: "0.06em" }}>
                  {profile.full_name.split(" ")[0]}
                </span>
              )}
              <ChevronDown size={12} color="#9BA0A8" style={{ transform: dropdownOpen ? "rotate(180deg)" : "rotate(0deg)", transition: "transform 0.15s" }} />
            </div>

            {dropdownOpen && (
              <div style={{ position: "absolute", top: "calc(100% + 8px)", right: 0, background: "#20242A", border: "0.5px solid rgba(255,255,255,0.08)", borderTop: "2px solid #A91E22", minWidth: "220px", zIndex: 100 }}>
                <div style={{ padding: "14px 16px", borderBottom: "0.5px solid rgba(255,255,255,0.06)" }}>
                  ...
                  <p style={{ fontSize: "11px", color: "#8B919A", margin: "2px 0 0", fontFamily: "'Barlow', sans-serif" }}>{profile?.email}</p>
                  <p style={{ fontSize: "10px", color: "#666C75", margin: "2px 0 0", fontFamily: "'Barlow Condensed', sans-serif", letterSpacing: "0.08em", textTransform: "uppercase" }}>{profile?.title || "Administrator"}</p>
                </div>
                ...
                {[
                  ...
                  <div key={item.label} onClick={item.action} style={{ display: "flex", alignItems: "center", gap: "10px", padding: "11px 16px", cursor: "pointer", fontSize: "13px", color: "#B5BAC2", fontFamily: "'Barlow', sans-serif", borderBottom: "0.5px solid rgba(255,255,255,0.04)" }}
