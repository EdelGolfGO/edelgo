...
export default function PricingPage() {
  ...
  const inputStyle = { background: "#23282E", border: "0.5px solid rgba(255,255,255,0.08)", color: "#fff", padding: "5px 8px", fontSize: "12px", fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 700, outline: "none", width: "90px", textAlign: "right" as const, boxSizing: "border-box" as const }
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
      ...
      <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", paddingBottom: "16px", borderBottom: "0.5px solid rgba(255,255,255,0.10)" }}>
        <div>
          ...
          <p style={{ fontSize: "12px", color: "#B5BAC2", marginTop: "5px", fontFamily: "'Barlow', sans-serif" }}>Manage Tier 1 (Wholesale), Tier 2 (Fitter), Tier 3 (Distributor) pricing</p>
        </div>
        <div style={{ display: "flex", gap: "10px" }}>
          ...
          <button onClick={handleSaveAll} disabled={saving} style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: "12px", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", color: "#fff", background: saved ? "#5A9E5A" : saving ? "#666C75" : "#A91E22", border: "none", padding: "8px 18px", cursor: "pointer", display: "flex", alignItems: "center", gap: "6px" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "10px" }}>
        {[
          ...
          <div key={t.label} style={{ background: "#2E343C", border: "0.5px solid rgba(255,255,255,0.10)", borderTop: `2px solid ${t.color}`, padding: "14px 16px" }}>
            ...
            <p style={{ fontSize: "12px", color: "#8B919A", fontFamily: "'Barlow', sans-serif", margin: 0 }}>{t.desc}</p>
          </div>
        ))}
      </div>
      ...
      <div style={{ background: "#2E343C", border: "0.5px solid rgba(255,255,255,0.10)", padding: "16px 20px" }}>
        <p style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: "10px", fontWeight: 700, letterSpacing: "0.16em", textTransform: "uppercase", color: "#8B919A", marginBottom: "12px" }}>Bulk Set by % of MSRP</p>
        <div style={{ display: "flex", gap: "12px", alignItems: "flex-end" }}>
          {[
            ...
            <div key={t.label}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "4px" }}>
                ...
                <span style={{ color: "#8B919A", fontFamily: "'Barlow Condensed', sans-serif", fontSize: "14px", fontWeight: 700 }}>%</span>
              </div>
            </div>
          ))}
          ...
          <p style={{ fontSize: "11px", color: "#787E87", fontFamily: "'Barlow', sans-serif", margin: 0 }}>Leave blank to skip that tier</p>
        </div>
      </div>

      {/* Filters */}
      <div style={{ display: "flex", gap: "12px", alignItems: "center" }}>
        <input placeholder="Search SKUs..." value={search} onChange={e => setSearch(e.target.value)} style={{ background: "#262B32", border: "0.5px solid rgba(255,255,255,0.10)", color: "#fff", padding: "8px 14px", fontSize: "12px", fontFamily: "'Barlow', sans-serif", outline: "none", width: "200px" }} />
        ...
        <span style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: "11px", color: "#787E87", letterSpacing: "0.08em" }}>{filtered.length} SKUs</span>
      </div>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse" }}>
            <thead>
              <tr style={{ background: "#262B32" }}>
                <th style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: "9px", fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "#8B919A", padding: "10px 14px", textAlign: "left", borderBottom: "0.5px solid rgba(255,255,255,0.08)" }}>SKU</th>
                <th style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: "9px", fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "#8B919A", padding: "10px 14px", textAlign: "left", borderBottom: "0.5px solid rgba(255,255,255,0.08)" }}>Name</th>
                <th style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: "9px", fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "#8B919A", padding: "10px 14px", textAlign: "right", borderBottom: "0.5px solid rgba(255,255,255,0.08)" }}>MSRP</th>
                ...
                <th style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: "9px", fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "#8B919A", padding: "10px 6px", textAlign: "right", borderBottom: "0.5px solid rgba(255,255,255,0.08)" }}>% MSRP</th>
            ...
            <tbody>
              {filtered.map(sku => (
                ...
                >
                  ...
                  <td style={{ padding: "7px 14px", fontSize: "12px", color: "#E0E2E6", fontFamily: "'Barlow', sans-serif", borderBottom: "0.5px solid rgba(255,255,255,0.04)", maxWidth: "200px", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{sku.name}</td>
                  <td style={{ padding: "7px 14px", borderBottom: "0.5px solid rgba(255,255,255,0.04)", textAlign: "right" }}>
                    <span style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: "12px", fontWeight: 700, color: "#B5BAC2" }}>${sku.msrp.toFixed(2)}</span>
                  </td>
                  ...
                  <td style={{ padding: "7px 6px", borderBottom: "0.5px solid rgba(255,255,255,0.04)", textAlign: "right" }}>
                    <span style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: "10px", color: "#787E87" }}>{sku.msrp > 0 && sku.tier1 > 0 ? `${(sku.tier1 / sku.msrp * 100).toFixed(0)}%` : "—"}</span>
                  </td>
                  <td style={{ padding: "4px 8px", borderBottom: "0.5px solid rgba(255,255,255,0.04)", textAlign: "right" }}>
                  ...
                  <td style={{ padding: "7px 6px", borderBottom: "0.5px solid rgba(255,255,255,0.04)", textAlign: "right" }}>
                    <span style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: "10px", color: "#787E87" }}>{sku.msrp > 0 && sku.tier2 > 0 ? `${(sku.tier2 / sku.msrp * 100).toFixed(0)}%` : "—"}</span>
                  </td>
                  <td style={{ padding: "4px 8px", borderBottom: "0.5px solid rgba(255,255,255,0.04)", textAlign: "right" }}>
                  ...
                  <td style={{ padding: "7px 6px", borderBottom: "0.5px solid rgba(255,255,255,0.04)", textAlign: "right" }}>
                    <span style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: "10px", color: "#787E87" }}>{sku.msrp > 0 && sku.tier3 > 0 ? `${(sku.tier3 / sku.msrp * 100).toFixed(0)}%` : "—"}</span>
                  </td>
                </tr>
              ))}
            </tbody>
